    ...
    <p>Quando se trabalha com outras pessoas e, principalmente, quando se ocupa um cargo de liderança, dominar técnicas de gestão de conflitos é algo fundamental para um líder que deseja construir equipes mais fortes.</p>
     ...
     <div class="container">
        ...
        <div class="topo">
            <ul class="nav">
                <li class="st st1" >
                    <h2 class="inner">Conflitos de recursos</h2>
                </li>
                <li class="st st2">
                    <h2 class="inner">Conflitos prioritários</h2>
                </li>
                <li class="st st3">
                    <h2 class="inner">Horários</h2>
                </li>
                <li class="st st4">
                    <h2 class="inner">Outras causas</h2>
                </li>
            </ul>
            <div class="line">
                <span></span>
        ...
        <ul class="timelineul" id="timeLine">
          <li>
            <div class="back-green" data-aos="fade-up-left">
              <time>Entendendo o Conflito em Profundidade</time>
             ...
             <p>Isso deve ser feito o mais rápido possível, porque se a questão não for vista ou levada em consideração dentro de um período razoável, o conflito aumenta gerando prejuízos para o time. Afinal, conflitos inibem a produtividade e geram distrações — isso afeta o trabalho, o ritmo e a organização como um todo.</p>
            </div>
            
          </li>
          <li>
            <div class="back-green" data-aos="fade-up-right">
              <time>Entendendo o Impacto e a Cooperação Necessária</time>
              ...
              <p>Às vezes, a questão é pequena e seu impacto também, mas a estratégia usada para resolver o problema é demorada, e então gasta-se tempo (que é dinheiro!) dos colaboradores. Assim, para evitar esse desperdício de tempo e dinheiro, deve-se avaliar o impacto adequadamente.</p>
            </div>
          </li>
          
          <li>
            <div class="back-green" data-aos="fade-up-left">
              <time>Comunicando com Clareza</time>
...
<div style="min-height: 50px;">
  <div class="collapse collapse-horizontal" id="collapseWidthExample">
    ...
    E, para se comunicar bem, é preciso ser um bom ouvinte, como recomendava Dale Carnegie: “Seja um bom ouvinte, incentive as pessoas a falar sobre elas mesmas.” Ouça o que os outros dizem e depois responda de acordo, mas de acordo com o que foi discutido. O modo em que ouvimos reflete na forma em que pensamos. Esteja focado, engaje-se e seja sincero! Uma boa cultura de comunicação ajudará todos os membros a evitar e resolver conflitos com mais rapidez.
          ...
          <li>
            <div class="back-green" data-aos="fade-up-right">
              <time>Ampliando a Situação</time>
          ...
          <li>
            <div class="back-green" data-aos="fade-up-left">
              <time>Esclarecendo as Posições</time>
          ...
          <li>
            <div class="back-green" data-aos="fade-up-left">
              <time>Criando Grupos Menores</time>
